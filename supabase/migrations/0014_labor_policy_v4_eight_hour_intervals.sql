-- Labor policy v4: one hour of released interval for every complete eight-hour
-- operational period in each employee's local calendar day.
...
values
  ('00000000-0000-4000-a000-000000000014'::uuid,
   'Política CLT Padrão', 4, 'approved', current_date, now(),
   ...
   '{
      ...
      "journeyIntervalEveryMinutes": 480,
