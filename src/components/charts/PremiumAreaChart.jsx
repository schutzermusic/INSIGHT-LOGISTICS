...
/**
 * Premium area chart on Apache ECharts.
 *
...
export function PremiumAreaChart({
    ...
    return {
      ...
      series: series.map((s, i) => {
        ...
        return {
          ...
          itemStyle: { color },
          areaStyle: {
            color: makeAreaGradient(color, isDark),
          },
  ...
  if (isEmpty) {
    return <ChartEmpty message={emptyMessage} variant="area" action={emptyAction} height={height} className={className} />;
  }
  return (
