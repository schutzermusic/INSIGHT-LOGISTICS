...
export function ThemeToggle({
  ...
  // Sync the uncontrolled variant with the global Tailwind dark class on mount.
  useEffect(() => {
    if (controlledTheme == null && typeof document !== "undefined") {
  ...
  const toggle = useCallback(() => {
    ...
    setTimeout(() => {
      if (controlledTheme == null) setInternalTheme(next);
      onThemeChange?.(next);
  ...
  }, [phase, theme, duration, onThemeChange, controlledTheme]);
        ...
        {isAppBar && appBarProps?.onSearch && (
          <div style={{ ...appBarSectionStyle, flex: 1, justifyContent: "center" }}>
            <div
              ...
              <div
                style={{ position: "absolute", left: "12px", display: "flex", opacity: 0.6 }}>
                <SearchIcon />
              </div>
              <input
                type="text"
